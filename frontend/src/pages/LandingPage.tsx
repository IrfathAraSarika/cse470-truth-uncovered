      ...
      <main className="relative z-10 max-w-[1200px] mx-auto px-6 pt-10 md:pt-14 pb-16">
        ...
        <section id="platform" className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Card 6 */}
            <div className="rounded-xl p-[1px] bg-gradient-to-b from-white/10 to-transparent">
              <div className="h-full rounded-xl bg-[#131313]/25 border border-white/[0.03] p-6 hover:border-[#ff5634]/30 hover:bg-[#131313]/40 transition-all duration-300 flex flex-col justify-between min-h-[220px]">
                <div>
                  <div className="w-8 h-8 rounded-[6px] bg-[#ff5634]/10 border border-[#ff5634]/20 flex items-center justify-center mb-4">
                  ...
                  <h3 className="font-['Sora'] text-base font-semibold text-white mb-2">Awareness & Legal Rights</h3>
                  <p className="text-[13px] text-gray-400 leading-relaxed">
                    Empowering citizens with educational articles, legal frameworks, and reporting guides.
                  </p>
                </div>
