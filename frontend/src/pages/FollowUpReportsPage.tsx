  ...
  return (
    <div className="min-h-screen bg-bg-dark text-on-surface font-inter">
      ...
      <main className="max-w-[1200px] mx-auto px-6 py-12">
        <h1 className="font-sora text-4xl font-bold text-white mb-4">Case Follow-Ups</h1>
        <p className="text-on-surface/70">Recursive case follow-up threads and investigative updates.</p>
      </main>
    </div>
  );
}
