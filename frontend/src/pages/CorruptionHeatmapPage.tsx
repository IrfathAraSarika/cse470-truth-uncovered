  ...
  return (
    <div className="min-h-screen bg-bg-dark text-on-surface font-inter">
      ...
      <main className="max-w-[1200px] mx-auto px-6 py-12">
        <h1 className="font-sora text-4xl font-bold text-white mb-4">Corruption Heatmap</h1>
        <p className="text-on-surface/70">Interactive map showing corruption hotspots by region.</p>
      </main>
    </div>
  );
}
